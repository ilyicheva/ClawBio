...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>Polygenic Risk Score Report - All Available Traits</title>
  <style>
    body {{ font: 15px/1.6 -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; margin: 0; background: #f7f8fb; color: #1f2933; }}
    header {{ background: #17265f; color: white; padding: 22px 28px; }}
    main {{ max-width: 1100px; margin: 0 auto; padding: 28px; }}
    h1 {{ margin: 0; font-size: 26px; }}
    table {{ width: 100%; border-collapse: collapse; background: white; border: 1px solid #dcdfe5; }}
    th, td {{ padding: 10px 12px; border-bottom: 1px solid #dcdfe5; text-align: left; vertical-align: top; }}
    th {{ background: #eef2ff; color: #17265f; }}
    tr:nth-child(even) {{ background: #fafbff; }}
    a {{ color: #17265f; font-weight: 700; }}
    .disclaimer {{ margin-top: 20px; background: #fff3e0; border: 1px solid #ffcc80; border-radius: 6px; padding: 10px 14px; color: #8a4b00; }}
  </style>
</head>
<body>
  <header><h1>Polygenic Risk Score Report - All Available Traits</h1></header>
  <main>
    ...
    <p class="disclaimer">Research and educational use only. This is not a medical device and does not provide clinical diagnoses or personalised medical advice.</p>
  </main>
</body>
</html>
"""
